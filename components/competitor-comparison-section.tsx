...
export default function CompetitorComparisonSection() {
  ...
  const comparisonItems = [
    { feature: "Propriedades antibacterianas", titanus: true, competitor: false },
    { feature: "Livre de BPA e toxinas", titanus: true, competitor: false },
    { feature: "Pode ser lavado na máquina de lavar louça", titanus: true, competitor: false },
    { feature: "Resistente a odores e manchas", titanus: true, competitor: false },
    { feature: "Design amigável à faca", titanus: true, competitor: true },
    { feature: "Durável para toda a vida", titanus: true, competitor: false },
    { feature: "Dupla face", titanus: true, competitor: true },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            plástico abrigam bactérias, liberam toxinas e se desgastam rapidamente – a Titanus Cut® revoluciona o mercado
            ...
            <div className="flex items-center justify-center gap-4 sm:gap-8">
              <div className="flex-shrink-0">
                <Image
                  ...
                  alt="Tábua de corte de titânio Titanus Cut®"
                  width={150}
                  height={120}
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div className="grid grid-cols-3 gap-0">
              ...
              <div className="bg-gray-50 p-4 border-b border-l border-gray-200 text-center">
                <span className="font-medium text-gray-900">Titanus Cut®</span>
              </div>
              <div className="bg-gray-50 p-4 border-b border-l border-gray-200 text-center">
